...
Assert-Contains "templates/live-studio/ModProject/Mod.cs" "onLog:\s*message\s*=>\s*MainThreadDispatcher\.Enqueue" "LIVE Studio log callbacks must be marshalled to the main thread."
...
Assert-Contains "templates/live-studio/references/template-contract.md" "EnqueueGameplay" "Template contract must document the gameplay dispatcher helper."
...
Assert-Contains "docs/dify-knowledge/live-studio-template/template-contract.md" "EnqueueGameplay" "Dify template knowledge must document dispatcher usage."
